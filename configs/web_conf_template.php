...
return array(
	...
	// 'host_name'            => 'http://192.168.1.227:8888', 

	'root_path'            => '/shopraider/shopraider_site',
	...
	'session'              => array('save_handler' => 'redis', // files-文件存储，redis-redis存储
					                'save_path'    => 'tcp://localhost:6379', // 保存路径 ，files-'/tmp'或'C:\WINDOWS\Temp'  redis-'tcp://localhost:6379'
	), // session配置
